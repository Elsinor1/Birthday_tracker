...
class App(tk.Tk):
    def __init__(self):
        ...
        # Birthday frame
        self.birthday_frame = tk.Frame(self.main_frame, highlightbackground="blue", highlightthickness=2)
        ...
        self.last_name_label = tk.Label(self.add_contact_frame, text="Last name")
        ...
        self.birthday_label = tk.Label(self.add_contact_frame, text="Birthday MM/DD")
        ...
        self.email_label = tk.Label(self.add_contact_frame, text="Email address")
    ...
    def add_to_contacts(self):
        try:
            contact = Contact(first=self.first_name_entry.get(), birthday=self.birthday_entry.get())
